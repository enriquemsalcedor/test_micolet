...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference("Preference.count") do
      post preferences_url, params: { preference: { name: @preference.name, status: @preference.status } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { name: @preference.name, status: @preference.status } }
